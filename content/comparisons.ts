...
export const comparisonsData: ComparisonsData = {
    ...
    rows: [
      {
        ...
        category: 'P2P',
        neoflo: { score: 'Strong', note: 'Trained on a real invoice corpus (Zalora); strong on SEA + complex formats' },
  ...
  workflowMap: {
    ...
    vendorCoverage: [
      ...
      { vendor: 'Medius', category: 'AI-native AP / VIM-displacement (Nordic)', p2pCoverage: '4, 5, 6, 7 (AP automation + fraud controls)', o2cCoverage: 'None', r2rCoverage: 'None', primaryMonetization: 'Quote-based ARR' },
      { vendor: 'ChatFin', category: 'AI-agent R2R (recs + anomaly)', p2pCoverage: 'None', o2cCoverage: 'None', r2rCoverage: '3 (recs), 4 (anomaly / flux)', primaryMonetization: 'Subscription' },
      { vendor: 'Rillet', category: 'AI-native ERP (native GL) — watch-item', p2pCoverage: '4 (AP sync, BILL partnership)', o2cCoverage: '3, 4 (billing, rev-rec)', r2rCoverage: '1, 2, 3, 7 (real-time "zero-day" close on a native ledger)', primaryMonetization: 'ERP subscription' },
      { vendor: 'Campfire', category: 'AI-native ERP — watch-item', p2pCoverage: '4 (AP recon)', o2cCoverage: '4 (AR recon, rev-rec)', r2rCoverage: '1, 2, 3, 5 (continuous close + consolidation on a native ledger)', primaryMonetization: 'ERP subscription' },
    ],
